...
// var lightSvgs = document.querySelectorAll(".lightsvg");
// var darkSvgs = document.querySelectorAll(".darksvg");

// checkbox.addEventListener("change", function () {
//     var isChecked = checkbox.checked;
//     for (var i = 0; i < yearlyTabs.length; i++) {
//         if (isChecked) {
//             lightSvgs[i].classList.remove("active");
//             darkSvgs[i].classList.add("active");
//         } else {
//             darkSvgs[i].classList.remove("active");
//             lightSvgs[i].classList.add("active");
//         }
//     }
// });
...
checkbox.addEventListener("change", function () {
    ...
    // Define tab sets and their corresponding themes
    var tabSets = [
        { id: "dashboards", themes: ["lighttheme", "darktheme"] },
        { id: "pages", themes: ["lighttheme", "darktheme"] },
        { id: "ecommerce", themes: ["lighttheme", "darktheme"] },
        { id: "authentication", themes: ["lighttheme", "darktheme"] },
        { id: "tasks", themes: ["lighttheme", "darktheme"] },
        { id: "landing", themes: ["lighttheme", "darktheme"] }
    ];

    // Iterate over each tab set
    tabSets.forEach(function(tabSet) {
        var tabs = document.querySelectorAll("#" + tabSet.id + " .tab-content");

        tabs.forEach(function(tab) {
            tabSet.themes.forEach(function(theme) {
                if (tab.classList.contains(theme)) {
                    if (isChecked && theme === "darktheme") {
                        tab.classList.add("show");
                    } else if (!isChecked && theme === "lighttheme") {
                        tab.classList.add("show");
                    } else {
...
var checkbox = document.querySelector(".switcher-pricing input[type='checkbox']");
var lightsvg = document.querySelector(".lightsvg");
var darksvg = document.querySelector(".darksvg");

checkbox.addEventListener("change", function () {
    if (checkbox.checked) {
        lightsvg.classList.remove("active");
        darksvg.classList.add("active");
    } else {
        lightsvg.classList.add("active");
        darksvg.classList.remove("active");
    }
});