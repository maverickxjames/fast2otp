...
let changeTheInfo = (element, name, img, status) => {
    ...
    let image = `https://laravelui.spruko.com/tailwind/xintra/build/assets/images/faces/${img}.jpg`
...
new FgEmojiPicker({
    ...
    position: ['top', 'right'],
    preFetch: true,
    dir:"https://laravelui.spruko.com/tailwind/xintra/build/assets/libs/fg-emoji-picker/"
});
