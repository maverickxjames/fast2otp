                            ...
                            <div class="box-body p-[3rem]">
                                ...
                                <div class="flex mb-3 justify-between gap-2 flex-wrap flex-lg-nowrap">
                                    <button
                                        ...
                                        <span class="leading-[1.2rem] ms-2 text-[13px] text-defaulttextcolor">Signup
                                            with Google</span>
                                    </button>
                                </div>
                                ...
                                <div class="grid grid-cols-12 gap-y-4">
                                    <div class="xl:col-span-12 col-span-12">
                                        <label for="signin-username" class="form-label text-defaulttextcolor">Email
                                            Account</label>
                                    ...
                                    <div class="xl:col-span-12 col-span-12 mb-2">
                                        <label for="signin-password"
                                            class="form-label text-defaulttextcolor block">Password<a
                                                href="javascript:void(0);" onclick="sendPasswordResetOTP()"
                                                class="float-end font-normal text-textmuted dark:text-textmuted/50">Forget
                                                password ?</a></label>
                                        <div class="relative">
                                            <input type="password" id="loginPassword"
                                                class="form-control create-password-input" placeholder="password">
                                ...
                                <div class="text-center">
                                    <p class="text-textmuted dark:text-textmuted/50 mt-3 mb-0">Dont have an account? <a
                                            href="/register" class="text-primary">Sign Up</a></p>
                                </div>
            ...
            <div class="authentication-cover overflow-hidden">
                ...
                <div class="aunthentication-cover-content flex items-center justify-center">
                    <div>
                        ...
                        <p class="text-white mb-1 op-6">Welcome to the Admin Dashboard. Please log in to securely
                            manage your administrative tools and oversee platform activities. Your credentials ensure
                            system integrity and functionality.</p>
                    </div>
                </div>
            </div>
        </div>
